...
public class WheelView extends View {
    ...
    private static final int VELOCITY_FLING = 20;//修改这个值可以改变滑行速度//TODO:默认为5
    ...
    private void smoothScroll(int actionType) {
        ...
        if (actionType == ACTION_FLING || actionType == ACTION_DRAG) {
            ...
            if ((float) offset > itemHeight / 1.45F) {//如果超过Item高度的一半，滚动到下一个Item去//TODO:默认为2.0F
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                float dy = previousY - event.getRawY()-5;//TODO: 默认没有-5
                previousY = event.getRawY();
        ...
        public final void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WHAT_SMOOTH_SCROLL:
                    view.smoothScroll(ACTION_FLING);
                    break;
